...
FIELD_ORDER = ["report_type", "internal_only", "name", "date", "field_unknown_1"]
FIELD_TYPES = {
    "report_type": "react_select",
    "internal_only": "checkbox",
    "name": "textbox",
    "date": "date",
    "field_unknown_1": "react_select"
}
...
def open_form(page: Page):
    ...
    base_test_create_service_report_from_from_within_a_ticket_service_reports_tab_recorded.py — edit selectors here if the
    navigation path changes."""
    page.goto("http://localhost:3000/cases")
    page.wait_for_load_state("domcontentloaded")
    _dismiss_tour(page)
    page.get_by_placeholder("Search...", exact=True).first.fill('skddjafklsjklfjslajsaf')
    _click_through_tour(page, page.get_by_text('skddjafklsjklfjslajsaf').first)
    _dismiss_tour(page)  # navigating into the ticket can re-trigger the tour
    try:
        page.wait_for_load_state("networkidle", timeout=5000)
    except Exception:
        pass
    _click_menu_item(page, 'Service Reports')
    try:
        page.wait_for_load_state("networkidle", timeout=5000)
    except Exception:
        pass
    _click_through_tour(page, page.get_by_role("button", name="Service Report", exact=True))
    try:
        page.wait_for_load_state("networkidle", timeout=5000)
    except Exception:
        pass
...
def set_field(page: Page, field: str, value):
    ...
    if field == "report_type":
        _select_option(page, page.get_by_role("combobox", name="Time & Material Service Report"), value)
    ...
    elif field == "field_unknown_1":
        _select_option(page, page.locator(".MuiInputBase-root.MuiOutlinedInput-root.MuiInputBase-colorPrimary.MuiInputBase-fullWidth.MuiInputBase-formControl.MuiInputBase-sizeSmall.MuiInputBase-adornedStart"), value)
    else:
...
def read_field(page: Page, field: str):
    ...
    if field == "report_type":
        ...
        return (page.locator(".MuiInputBase-root.MuiOutlinedInput-root.MuiInputBase-colorPrimary.MuiInputBase-fullWidth.MuiInputBase-formControl.MuiInputBase-sizeSmall.MuiInputBase-adornedStart")).text_content() or ""
    else:
        raise ValueError(f"Unknown field: {field}")
...
def open_field(page: Page, field: str):
    ...
    if field == "report_type":
        _open_dropdown(page, page.get_by_role("combobox", name="Time & Material Service Report"))
    elif field == "internal_only":
        ...
        _open_dropdown(page, page.locator(".MuiInputBase-root.MuiOutlinedInput-root.MuiInputBase-colorPrimary.MuiInputBase-fullWidth.MuiInputBase-formControl.MuiInputBase-sizeSmall.MuiInputBase-adornedStart"))
    else:
        raise ValueError(f"Unknown field: {field}")
...
def is_field_present(page: Page, field: str) -> bool:
    ...
    if field == "report_type":
        ...
        return (page.locator(".MuiInputBase-root.MuiOutlinedInput-root.MuiInputBase-colorPrimary.MuiInputBase-fullWidth.MuiInputBase-formControl.MuiInputBase-sizeSmall.MuiInputBase-adornedStart")).count() > 0
    else:
        raise ValueError(f"Unknown field: {field}")
...
def run_test(page: Page, inputs: dict, expected_outcome: str, expected_message: str):
    """
    Execute one create_service_report/create_service_report_from_from_within_a_ticket_service_reports_tab scenario.

    inputs keys : report_type, internal_only, name, date, field_unknown_1
    ...
    _dismiss_tour(page)
    try:
        _click_through_tour(page, page.get_by_role("button", name="Save"), timeout_ms=5000)
    except Exception:
